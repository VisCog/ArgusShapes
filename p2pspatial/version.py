...
description = "p2pspatial: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/p2pspatial/blob/master/README.md

License
=======
``p2pspatial`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/p2pspatial"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'p2pspatial': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
