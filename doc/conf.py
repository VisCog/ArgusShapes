...
# -*- coding: utf-8 -*-
#
# argus_shapes documentation build configuration file, created by
...
htmlhelp_basename = 'argus_shapesdoc'
...
latex_documents = [
  ('index', 'argus_shapes.tex', 'argus_shapes Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'argus_shapes', 'argus_shapes Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'argus_shapes', 'argus_shapes Documentation',
   'Ariel Rokem', 'argus_shapes', 'One line description of project.',
   'Miscellaneous'),
]
