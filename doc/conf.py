...
# -*- coding: utf-8 -*-
#
# p2pspatial documentation build configuration file, created by
...
htmlhelp_basename = 'p2pspatialdoc'
...
latex_documents = [
  ('index', 'p2pspatial.tex', 'p2pspatial Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'p2pspatial', 'p2pspatial Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'p2pspatial', 'p2pspatial Documentation',
   'Ariel Rokem', 'p2pspatial', 'One line description of project.',
   'Miscellaneous'),
]
