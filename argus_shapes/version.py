...
description = "argus_shapes: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/argus_shapes/blob/master/README.md

License
=======
``argus_shapes`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/argus_shapes"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'argus_shapes': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
